                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            Swal.fire({
                                icon: 'success', title: data.success, text: data.message,
                            });
                        } else {
                            Swal.fire({
                                icon: 'error', title: 'Hiba!', text: data.error,
                            })
                        }
                    }
                });
    ...
    $(".deleteTestAttempt").click(function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const reqId = params["id"];
                $.ajax({
                    type: 'DELETE', url: "/attempt/delete", data: {testAttemptId: reqId}, success: function (data) {
                        if (data.success !== undefined) {
                            document.getElementById(`testAttempt#${reqId}`).remove();
                            Swal.fire({
                                icon: 'success', title: 'Siker!', text: data.error,
                            })
