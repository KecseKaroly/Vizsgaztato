                                                    ...
                                                    <div
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <label for="option_{{$option['id']}}"
                                                                               class="hover:cursor-pointer break-words font-sans pl-2 w-full text-md italic font-normal text-gray-900">{{$option['text']}}</label>
                                                                    </div>
                                                    @break
                                                @case('OneChoice')
                                                    <div
                                                                        ...
                                                                        <label
                                                                            ...
                                                                            class="hover:cursor-pointer break-words font-sans pl-2 w-full text-md italic font-normal text-gray-900">
                                                                            {{$option['text']}}</label>
                                                                    </div>
                                                    @break
                                                    @case('MultipleChoice')
                                                    ...
                                                    @case('Sequence')
                                                        <div
                                                                        @class([
                                                                                "hover:cursor-pointer border-4 lg:mx-16 lg:px-8 lg:my-4 lg:py-2 mx-2 my-1 py-1 pl-6 flex items-center rounded border  bg-slate-100 hover:bg-slate-300",
