        ...
        <div class="flex flex-col max-w-full mx-auto rounded-xl overflow-hidden w-11/12">
            ...
            <div class="flex md:flex-row-reverse flex-col">
                <div class="md:pl-5 md:w-1/2 md:h-[75vh] h-[30vh] md:flex md:flex-col md:justify-between">
                    <div
                        class="bg-indigo-300 rounded-xl h-[17vh]  md:flex md:flex-col md:space-y-2 md:justify-evenly overflow-y-auto md:mb-0 mb-4">
                        <div class="flex flex-wrap content-center justify-between px-6 text-center">
                            <div class="italic font-semibold text-lg w-full">Bejelentkezve mint: {{ auth()->user()->name }}</div>
                            <a href="{{ route('users.show', auth()->user()) }}" class="mx-auto block font-bold text-lg rounded-lg w-fit bg-indigo-500 hover:bg-indigo-600 px-12 py-4 ">Profilom</a>
                        </div>
                    </div>
                    <div class="bg-lime-400 rounded-xl">
                        <div class="flex content-end justify-between px-2 pt-2">
                            ...
                            <a href="{{ route('groups.index') }}" class="italic block text-lime-900 md:text-base text-xs pt-1 font-semibold">Minden
                        ...
                        <div class="md:h-[50vh] h-[30vh] overflow-y-auto md:flex md:flex-col md:space-y-2 md:justify-evenly py-2">
                            @forelse($groups as $group)
                                <div
                                    class="my-2 bg-lime-900 w-11/12 mx-auto text-gray-100 px-6 py-2.5 rounded flex flex-wrap justify-between items-center">
                                    ...
                                    <div>
                                        <a href="{{ route('groups.show', $group->id) }}">
                                            <button
                                                class="text-2xl md:w-10 md:h-10 w-8 h-8 rounded-full bg-lime-500 hover:bg-lime-600 text-white">
                ...
                <div class="md:mt-0 mt-44 bg-yellow-200 rounded-xl md:w-1/2">
                    <div class="flex content-end justify-between px-2 pt-2">
                        <div class="font-bold md:text-xl text-base">Kurzusok:</div>
                        <a href="{{ route('courses.index') }}" class="italic block text-yellow-900 md:text-base text-xs pt-1 font-semibold">Minden
